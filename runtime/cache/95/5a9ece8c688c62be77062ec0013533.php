...
<div id="wrapper">
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong> binghe &copy; 2016-2020            </div>
        </div>
...
<script>    layui.use(['form'], function(){        var $ = layui.$            ,form = layui.form;        //监听提交        form.on('submit(app-install-submit)', function(data){            var field = data.field;            //console.log(field)            //提交安装            $.ajax({                url:'/install/Index/step2.html',                method:"POST",                data:field,                beforeSend: function() {                    layer.load(1);                },                complete: function() {                    layer.closeAll('loading');                },                success:function (res) {                    layer.msg(res.msg);                    if (res.code == 1){                        setTimeout(function () {                            location.href = '/'                        },1500)                    }                }            });        });    });</script>

</body>

</html>
";i:1;a:4:{s:12:"Content-Type";s:24:"text/html; charset=utf-8";s:13:"Cache-Control";s:24:"max-age=,must-revalidate";s:13:"Last-Modified";s:29:"Fri, 27 Mar 2020 01:32:09 GMT";s:7:"Expires";s:29:"Fri, 27 Mar 2020 01:32:09 GMT";}i:2;i:1585272729;}