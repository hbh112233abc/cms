...
class Article extends TagLib
{
    ...
    public function tagPrev($tag, $content)
    {
        ...
        $parse .= "    $id = \app\common\model\ArticleModel::hasWhere('CategoryArticle', [['category_id','in',\$cids]])->where(\$where)->field('id,title,post_time,author')->order('id asc')->find();";
        $parse .= "  } else {";
        $parse .= "    \$ArticleModel = new \app\common\model\ArticleModel();";
    ...
    public function tagNext($tag, $content)
    {
        ...
        $parse .= "    \$cids = \$childs['ids'];";
        $parse .= "    array_push(\$cids, $internalCid);";
        $parse .= "    $id = \app\common\model\ArticleModel::hasWhere('CategoryArticle', [['category_id','in',\$cids]])->where(\$where)->field('id,title,post_time,author')->order('id desc')->find();";
        $parse .= "  } else {";
        $parse .= "    \$ArticleModel = new \app\common\model\ArticleModel();";
    ...
    public function tagList($tag, $content)
    {
        ...
        $parse .= "      \$cids = \$childs['ids'];";
        $parse .= "      array_push(\$cids, $internalCid);";
        $parse .= "      $internalList = \app\common\model\ArticleModel::hasWhere('CategoryArticle', [['category_id','in',\$cids]])->where(\$where)->field(\$targetFields)->order('is_top desc,sort,post_time desc')->paginate($pageSize,false,['query'=>input('param.')]);";
        $parse .= "    } else { ";
        $parse .= "      \$ArticleModel = new \app\common\model\ArticleModel();";
    ...
    public function tagHotlist($tag, $content)
    {
        ...
        $parse .= "      \$cids = \$childs['ids'];";
        $parse .= "      array_push(\$cids, $internalCid);";
        $parse .= "      $internalList = \app\common\model\ArticleModel::hasWhere('CategoryArticle', [['category_id','in',\$cids]])->where(\$where)->field(\$field)->order('read_count desc')->limit($limit)->select();";
        $parse .= "    } else { ";
    ...
    public function tagLatestlist($tag, $content)
    {
        ...
        $parse .= "      \$cids = \$childs['ids'];";
        $parse .= "      array_push(\$cids, $internalCid);";
        $parse .= "      $internalList = \app\common\model\ArticleModel::hasWhere('CategoryArticle', [['category_id','in',\$cids]])->where(\$where)->field(\$field)->order('post_time desc')->limit($limit)->select();";
        $parse .= "    } else { ";
    ...
    public function tagRandomlist($tag, $content)
    {
        ...
        $parse .= "      \$cids = \$childs['ids'];";
        $parse .= "      array_push(\$cids, $internalCid);";
        $parse .= "      $internalList = \app\common\model\ArticleModel::hasWhere('CategoryArticle', [['category_id','in',\$cids]])->where(\$where)->field(\$field)->orderRand()->limit($limit)->select();";
        $parse .= "    } else { ";
