...
trait File
{
    ...
    public function upload()
    {
        ...
        if (!$check) {
            ...
            return $this->result(null, 0, $file->getError(), 'json');
        }
    ...
    public function uploadSoftware()
    {
        ...
        $saveName = Filesystem::putFile('software' . DIRECTORY_SEPARATOR . $version, $file);
        ...
        return $this->success('文件上传成功', false, $data);
    }
    ...
    public function uploadApp()
    {
        ...
        $saveName = Filesystem::putFile('app' . DIRECTORY_SEPARATOR . $version, $saveName);
