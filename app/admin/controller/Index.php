...
class Index extends Base
{
    ...
    public function dashboard()
    {
        ...
        View::assign('todayCount', $todayCount);
        View::assign('curWeekCount', $curWeekCount);
        View::assign('curMonthCount', $curMonthCount);

        View::assign('waitForPublishCount', $waitForPublishCount);
        View::assign('waitForAuditCount', $waitForAuditCount);

        View::assign('dayPercent', $dayPercent);
        View::assign('weekPercent', $weekPercent);
        View::assign('monthPercent', $monthPercent);
